...
var things = ["Talking", "Sleeping", "Laughing", "Crying", "Eating", "Napping"];
var programmers = ["Talker", "Sleeper", "Laugher", "Cryer", "Eater", "Napper"]
...
q.innerHTML =
    "\"The " + programmer +
    ", like the student, does not work. He destroys his " +
    life + " in the " + air + ", from " + air + ", creating by " + exertion + " of the imagination.\"" +
    "\u2014" +  "Zayd Normand, " + programmer;
